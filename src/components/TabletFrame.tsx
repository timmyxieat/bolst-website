...
export function TabletFrame() {
  return (
    <div className="bg-white relative w-[1024px] overflow-clip" data-name="Tablet">
      {/* Image */}
      <div className="absolute contents left-0 top-[86px]">
        <div className="absolute h-[575.582px] left-0 top-[86px] w-[1024px]">
        ...
        <div className="absolute bg-[#e1e0e1] h-[75.135px] left-[928.23px] top-[573.48px] w-[69.768px]" />
      </div>

      {/* Header */}
      <div className="absolute box-border content-stretch flex items-center justify-between left-0 px-[32px] py-[20px] top-0 w-[1024px]">
      ...
      {/* Gradient Background */}
      <div className="absolute bg-gradient-to-r from-[#e7e7e7] h-[484px] left-0 to-[#e1e1e1] top-[649px] via-[#e5e5e5] via-[49.472%] w-[1024px]" />
      ...
      {/* Form */}
      <form className="absolute left-[130px] top-[917px] flex gap-[12px]">
        <input 
          type="email" 
