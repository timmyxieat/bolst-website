import svgPaths from "./svg-wgx0zuqm38";
...
function Div() {
  return (
    <div className="absolute content-stretch flex gap-[8px] items-center left-[32px] top-[16px]" data-name="div">
      <div aria-hidden="true" className="absolute border-0 border-gray-200 border-solid inset-0 pointer-events-none" />
      <I />
  ...
  return (
    <div className="bg-white relative size-full" data-name="iPhone 16 Pro Max - 2">
      <div className="flex flex-col justify-end size-full">
        <div className="box-border content-stretch flex flex-col gap-[10px] items-start justify-end pb-[120px] pt-[16px] px-[32px] relative size-full">
          <div className="absolute left-[-681px] size-[1248px] top-[-226px]" data-name="Pillow 5">
