import svgPaths from "./svg-fk8jb1a2i2";
...
function Image() {
  return (
    <div className="absolute contents left-0 top-[86px]" data-name="Image">
      <div className="absolute h-[575.582px] left-0 top-[86px] w-[744px]" data-name="Gemini_Generated_Image_850g62850g62850g 1">
      ...
      <div className="absolute bg-[#e1e0e1] h-[75.135px] left-[674.23px] top-[573.48px] w-[69.768px]" />
    </div>
  );
}
...
function Div1() {
  return (
    <div className="absolute box-border content-stretch flex items-center justify-between left-0 px-[32px] py-[20px] top-0 w-[744px]" data-name="div">
      <Div />
      <Nav />
    </div>
  );
...
function Input() {
  return (
    <div className="absolute bg-[#faf9f6] h-[50px] left-[130px] rounded-[8px] top-[917px] w-[331px]" data-name="input">
...
function Button() {
  return (
    <div className="absolute bg-[#024a60] h-[48px] left-[473px] rounded-[8px] top-[919px] w-[140.703px]" data-name="button">
...
function Group() {
  return (
    <div className="absolute contents left-[130px] top-[917px]">
      <Input />
      <Button />
    </div>
  );
...
export default function IPadMini() {
  return (
    <div className="bg-white relative size-full" data-name="iPad mini 8.3 - 1">
      <Image />
      <Div1 />
      <div className="absolute bg-gradient-to-r from-[#e7e7e7] h-[484px] left-0 to-[#e1e1e1] top-[649px] via-[#e5e5e5] via-[49.472%] w-[744px]" />
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[1.2] left-[calc(50%-0.5px)] not-italic text-[#024a60] text-[32px] text-center top-[662px] translate-x-[-50%] w-[467px]">Finally, Perfect Alignment. Every Night.</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[1.8] left-1/2 not-italic text-[#024a60] text-[20px] text-center top-[767px] translate-x-[-50%] w-[466px]">Contouring that hugs the curves of your head. No collapse, no constant adjusting, just restorative sleep you can count on.</p>
      <Group />
    </div>
  );
}