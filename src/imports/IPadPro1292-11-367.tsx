import svgPaths from "./svg-jhyg0w8wl0";
  ...
  return (
    <div className="bg-white relative size-full" data-name="iPad Pro 12.9' - 2">
      <div className="flex flex-col items-center justify-end size-full">
        <div className="box-border content-stretch flex flex-col gap-[32px] items-center justify-end pb-[360px] pt-[32px] px-[72px] relative size-full">
          <div className="absolute left-[-1226px] size-[2400px] top-[-619px]" data-name="Pillow 4">
